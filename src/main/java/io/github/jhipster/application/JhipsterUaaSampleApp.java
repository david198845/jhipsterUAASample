...
public class JhipsterUaaSampleApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterUaaSampleApp.class);

    private final Environment env;

    public JhipsterUaaSampleApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterUAASample.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterUaaSampleApp.class);
